...
The gate preserves negative outcomes: it cannot convert either molecule blocker into a success, cannot erase Claim 2's rounding limitation, and cannot extend Claim 6 beyond the source-primary scope. The fresh [v4 outcome-blind review](https://github.com/MachineLearning-Nerd/icml26-repro-qbe18sZPWS-routing-by-reaching/blob/main/evidence/BLIND_REVIEW_V4.md) scores the candidate evidence `8/12`—not a live leaderboard score—and records why Claims 3 and 4 prevent a perfect review.
